...
const SmallanimalProductDetail = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    setLoading(true);
    api.get(`smallanimalproducts/${id}/`).then((res) => {
      setProduct(res.data);
  ...
  const submitReview = async (e) => {
    ...
    try {
      await api.post(`smallanimalproducts/${id}/add_review/`, payload);
...
export default SmallanimalProductDetail;
